...
public class LinkedTree<E> implements NAryTree<E> {
    ...
    private TreeNode<E> checkPosition(Position<E> p) { //me lo creo aparte para poder trabajar con las posiciones
    ...
    }//se hace este metodo para comprobar que la posicion n es valida
    ...
    public void remove(Position<E> p) {
        ...
        if (node==root){
            ...
            size -= computeSize(node); //funcion para computar el tamaño del nodo
        }
    }
    ...
    private void breadthOrder(TreeNode<E> node, List<Position<E>> positions) {
        ...
        if(root != null){
            ...
            queue.add(node); //el add es el visit
            while(!queue.isEmpty()){//en vez de un for es un while
